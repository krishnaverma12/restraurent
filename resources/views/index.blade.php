               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image1.jpg')}}" class="image-popup" title="American Breakfast">
                                   <img src="{{asset('frontend/images/menu-image1.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image2.jpg')}}" class="image-popup" title="Self-made Salad">
                                   <img src="{{asset('frontend/images/menu-image2.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image3.jpg')}}" class="image-popup" title="Chinese Noodle">
                                   <img src="{{asset('frontend/images/menu-image3.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image4.jpg')}}" class="image-popup" title="Rice Soup">
                                   <img src="{{asset('frontend/images/menu-image4.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image5.jpg')}}" class="image-popup" title="Project title">
                                   <img src="{{asset('frontend/images/menu-image5.jpg')}}" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <!-- MENU THUMB -->
                         <div class="menu-thumb">
                              <a href="{{asset('frontend/images/menu-image6.jpg')}}" class="image-popup" title="Project title">
                                   <img src="{{asset('frontend/images/menu-image6.jpg')}}" class="img-responsive" alt="">
